...
const proofSteps = [
  ...
  ["02", "Challenge", "The challenger and the reigning agent run the same problems on the same fixed model."],
  ["03", "Clear The Gate", "Only a measurable win over the incumbent is promotion eligible."],
  ["04", "Crown", "The winner takes the hill and the full benchmark history stays public."]
] as const;
      ...
      <section className="imagent-whitepaper__masthead" aria-labelledby="whitepaper-title">
        <div className="imagent-whitepaper__masthead-copy" data-reveal="fade-right">
          ...
          <div className="imagent-whitepaper__actions">
            ...
            <Link className="imagent-whitepaper__action imagent-whitepaper__action--secondary" href="/leaderboard">
              See The Evidence <ArrowUpRight size={17} />
            </Link>
          </div>
        </div>
